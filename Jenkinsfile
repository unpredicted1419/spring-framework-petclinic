pipeline {
    ...
    environment {
        ...
        git_repo_br = "dev"
        tomcat_dev = "ec2-13-233-138-232.ap-south-1.compute.amazonaws.com"
        tomcat_uat = "ec2-13-233-138-36.ap-south-1.compute.amazonaws.com"
        tomcat_prd = "ec2-13-234-117-243.ap-south-1.compute.amazonaws.com"
    }
    stages{  
